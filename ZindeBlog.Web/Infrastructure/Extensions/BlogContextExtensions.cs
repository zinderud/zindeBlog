...
namespace ZindeBlog.Web.Infrastructure.Extensions
{
    public static class BlogContextExtensions
    {
        ...
        public static List<CategoryModel> QueryAllCategoryFromCache(this ZindeBlogContext context)
        {
        ...
        public static List<TagModel> QueryAllTagFromCache(this ZindeBlogContext context)
        {
        ...
        public static List<MonthStatisticsModel> QueryMonthStatisticsFromCache(this ZindeBlogContext context)
        {
        ...
        public static Dictionary<string, UserToken> QueryUserTokenFromCache(this ZindeBlogContext context)
        {
        ...
        public static List<User> QueryUserFromCache(this ZindeBlogContext context)
        {
        ...
        public static void RemoveCategoryCache(this ZindeBlogContext context)
        {
            RemoveCache(context, CacheKey_Category);
        }

        public static void RemoveTagCache(this ZindeBlogContext context)
        {
            RemoveCache(context, CacheKey_Tag);
        }

        public static void RemoveUserTokenCache(this ZindeBlogContext context)
        {
            RemoveCache(context, CacheKey_UserToken);
        }

        public static void RemoveUserCache(this ZindeBlogContext context)
        {
        ...
        private static T RetriveCache<T>(ZindeBlogContext context, string cacheKey, Func<T> func, MemoryCacheEntryOptions options = null)
        {
            var cache = context.GetService<IMemoryCache>();
            return cache.RetriveCache<T>(cacheKey, func, options);
        }

        private static void RemoveCache(ZindeBlogContext context, string cacheKey)
        {
            var cache = context.GetService<IMemoryCache>();
