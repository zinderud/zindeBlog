...
namespace ZindeBlog.Web.Infrastructure.Services
{
    public class TopicService
    {
        ...
        public TopicService(ZindeBlogContext blogContext, IMemoryCache cache, SettingModel settings, ClientManager clientManager)
        {
        ...
        public async Task<OperationResult<TopicModel>> Edit(EditTopicModel model)
        {
            ...
            if (entity == null)
            {
                return OperationResult<TopicModel>.Failure("TAg Service Failure");
            }
        ...
        private async Task<List<TopicModel>> Transform(params Topic[] entityList)
        {
            ...
            List<TopicModel> result = entityList.Select(entity =>
            {
                ...
                model.Tags = tagTopicList.Where(tag => tag.TopicID == entity.ID)
                    ...
                    .ToArray();
                model.Comments = new CommentCountModel();
